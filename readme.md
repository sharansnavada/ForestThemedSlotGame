...
UnityProject - Unity_Project consists of 5 folders(Scenes, ScriptableObjects, Scripts, sounds, Sprites)
				...
				3) Copy all the 5 folders inside this Unity_Project and Paste inside the asset folder
				4) Once you load the game and play it, texts wont come, go to any tmp on your hirerachy
				   and click on any tmp gameobject, you'll get a popup to install TMP_Essentials, download
				   both TMP_Essentials.